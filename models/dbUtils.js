...
var getTenderTypeRecords = function (outlet_id,from_date,to_date,ispublicsector, callback) {
    pg.connect(conString, function (err, client, done) {
        ...
        var query = "select outlet_name,starttime,endtime,to_char(saledate,'DD Month YYYY ') as saledate,cash_amount,card_amount,sodexocard_amount,sodexocoupon_amount,credit_amount,gprscard_amount,total from \
